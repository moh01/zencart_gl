...
// +----------------------------------------------------------------------+
//  $Id: products_to_categories.php 2909 2006-01-29 21:29:35Z Albigin $
//
...
define('BUTTON_COPY_CATEGORY_LINKED', 'Copia prodotticome linkati ');
...
// copy category to category linked
define('TEXT_INFO_RESET_ALL_PRODUCTS_TO_CATEGORY_MASTER', '<strong>Risettare TUTTI i Prodotti della categoria selezionata per utilizzare la categoria selezionata come la nuova ID Categoria Principale ...</strong><br />Esempio: risettando la Categoria 22 si imposteranno TUTTI i Prodotti della categoria 22 ad usare la Categoria 22 come ID Categoria Principale');
define('TEXT_INFO_RESET_ALL_PRODUCTS_TO_CATEGORY_FROM_MASTER', 'Risettare l\'ID categoria Principale per tutti i Prodotti della Categoria: ');
define('BUTTON_RESET_CATEGORY_MASTER', 'Risettare l\'ID Categorie Principali');
