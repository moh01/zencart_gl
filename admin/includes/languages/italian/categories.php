...
// +----------------------------------------------------------------------+
//  $Id: categories.php 2847 2006-01-13 07:40:50Z Albigin $
//
...
define('TEXT_DELETE_CATEGORY_INTRO_LINKED_PRODUCTS', '<strong>Avviso:</strong> I prodotti linkati a Categorie principali la cui ID è cancellata non saranno prezzati correttemente. Prima di cancellare una categoria contenente prodotti linkati assicurati di aver risettato l\'ID della Categoria principale del prodotto ad un\'altra categoria.');
...
define('TEXT_MOVE_CATEGORIES_INTRO', 'Selezionare la categoria nella quale sai desidera inserire <b>%s</b> ');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = Illimitato, 1 = N° Q.t&agrave; Confezioni');
