...
// +----------------------------------------------------------------------+
//  $Id: coupon_admin.php 3665 2006-07-04 04:51:37Z Deepmax $
//
...
define('TEXT_CONFIRM_DELETE', 'Davvero vuoi cancellare questo Buono?');
...
define('TEXT_VOUCHER_IS', 'Il codice del Buono &egrave; ');
...
define('COUPON_USES_USER_HELP', 'Numero delle volte in cui un utente pu&ograve; utilizzare il Buono, lasciare in bianco se non si voglioni limiti.');
