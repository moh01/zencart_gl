...
define('PDFOC_TEXT_SUBMIT', 'Submit Options');
...
define('PDFOC_MESSAGE_DELETE_ARE_YOU_SURE', 'Are you sure you want to delete all the orders in the orders list?');
...
define('PDFOC_ENTRY_INVOICE', 'FACTURE');
define('PDFOC_ENTRY_PACKING_SLIP', 'PACKING SLIP');
define('PDFOC_ENTRY_PHONE', 'Téléphone:');
define('PDFOC_ENTRY_QUOTE', 'PRICE QUOTE');
define('PDFOC_ENTRY_QUOTE_FOR', 'QUOTE FOR:');
define('PDFOC_ENTRY_PAYMENT_METHOD', 'Méthode de paiement:');
define('PDFOC_ENTRY_PAYMENT_TYPE', 'Credit Card:');
define('PDFOC_ENTRY_SHIPPING', 'Livraison:');
define('PDFOC_ENTRY_SHIP_TO', 'Adresse de livraison:');
define('PDFOC_ENTRY_SOLD_TO', 'Adresse de facturation:');
define('PDFOC_ENTRY_SUBTOTAL', 'Sous-Total:');
define('PDFOC_ENTRY_TAX', 'TVA:');
...
define('PDFOC_TABLE_HEADING_COMMENTS', 'Notes:');
define('PDFOC_TABLE_HEADING_PRICE_EXCLUDING_TAX', 'Prix UT HT');
define('PDFOC_TABLE_HEADING_PRICE_INCLUDING_TAX', 'Prix TTC');
define('PDFOC_TABLE_HEADING_PRODUCTS_MODEL', 'Référence');
define('PDFOC_TABLE_HEADING_PRODUCTS', 'Quantité et Désignation');
define('PDFOC_TABLE_HEADING_TAX', 'TVA');
define('PDFOC_TABLE_HEADING_TOTAL', 'Total');
define('PDFOC_TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Total HT');
define('PDFOC_TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Total TTC');
define('PDFOC_TEXT_COMMENTS','Notes:');
define('PDFOC_TEXT_INVOICE_DATE','Date de facture:');
define('PDFOC_TEXT_INVOICE_NUMBER','Numéro de facture:');
define('PDFOC_TEXT_ORDER_DATE','Date de commande:');
define('PDFOC_TEXT_ORDER_FORMAT','F j, Y');
define('PDFOC_TEXT_ORDER_NUMBER','Numéro de commande:');

// Settings for the order update e-mail to the customer
//
define('PDFOC_EMAIL_SALUTATION', '%s,');
define('PDFOC_EMAIL_SEPARATOR', '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-');
define('PDFOC_EMAIL_TEXT_COMMENTS_UPDATE', 'Comments concerning your order:' . "\n\n%s\n\n");
define('PDFOC_EMAIL_TEXT_DATE_ORDERED', 'Date de commande:');
define('PDFOC_EMAIL_TEXT_INVOICE_URL', 'Detailed Invoice:');
define('PDFOC_EMAIL_TEXT_ORDER_NUMBER', 'Numéro de commande:');
