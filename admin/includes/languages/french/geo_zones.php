...
//
  ...
  define('TEXT_INFO_HEADING_DELETE_ZONE', 'Edition de la Z&ocirc;ne');
  ...
  define('TEXT_INFO_COUNTRY_ZONE', 'Zône:');
  define('TYPE_BELOW', 'Toutes les Zônes');
  define('PLEASE_SELECT', 'Toutes Zônes');
  define('TEXT_ALL_COUNTRIES', 'Tous les Pays');

  define('TEXT_INFO_NUMBER_TAX_RATES','Nombre de Taux de Taxes:');
  define('ERROR_TAX_RATE_EXISTS','ATTENTION: des Taux de Taxes sont d&eacute;finis pour cette (ou ces) Zône(s). Veuillez supprimer le(s) Taux de Taxes avant d\'effacer cette Zône');
?>