...
define('HEADING_TITLE', 'Batch Status Updating');
...
define('HEADING_SELECT_STATUS', 'Select Status:');
define('HEADING_ADD_COMMENTS', 'Add Comments:');
...
define('SUCCESS_ORDER_UPDATED', 'Status has been updated successfully!');
define('WARNING_ORDER_NOT_UPDATED', 'Warning: No changes made to selected order(s).');
?>