...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', 'Special, le produit/t&eacute;l&eacute;chargement exige une adresse de livraison');
  ...
  define('TEXT_PRODUCTS_QUANTITY', 'Quantit&eacute; des Produits:');
  define('TEXT_PRODUCTS_MODEL', 'Mod&egrave;les des Produits:');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Copier toutes les Collections de Media Associ&eacute;es &agrave; ce produit.');
  ...
  define('TEXT_ATTRIBUTE_COPY_UPDATING','<strong>Acutualisation de l\'Attribut </strong>');
