...
/**
 *
 * @version $Id: document_general.php, v 1.3.7 2007/04/26 11:48:12 $;
 *
...
/* wlasne */
define( 'TEXT_DOCUMENT_STATUS', 'Status dokumentu: ' );
define( 'TEXT_DOCUMENT_AVAILABLE', 'Dostêpny' );
define( 'TEXT_DOCUMENT_NOT_AVAILABLE', 'Niedostêpny' );
define( 'TEXT_DOCUMENT_DATE_AVAILABLE', 'Data dostêpno¶ci: ' );
define( 'TEXT_DOCUMENT_NAME', 'Nazwa dokumentu: ' );
define( 'TEXT_PRODUCT_IS_FREE', 'Dokument darmowy: ' );
define( 'TEXT_PRODUCTS_IS_FREE_EDIT', '*Dokument jest oznaczony jako DARMOWY' );
define( 'TEXT_PRODUCT_IS_CALL', 'Cena na telefon: ' );
define( 'TEXT_PRODUCTS_IS_CALL_EDIT', '*Dokument jest oznaczony jako CENA NA TELEFON' );
define( 'TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES', 'Cena dokumentu zale¿na od cech: ' );
define( 'TEXT_PRODUCT_IS_PRICED_BY_ATTRIBUTE', 'Tak' );
define( 'TEXT_PRODUCT_NOT_PRICED_BY_ATTRIBUTE', 'Nie' );
define( 'TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT', '*Cena tego dokumentu zale¿y od jego cech, wybrana zostanie cena najni¿sza' );
define( 'TEXT_DOCUMENT_DETAILS', 'Tre¶æ: ' );
define( 'TEXT_DOCUMENT_IMAGE', 'Obrazek dokumentu: ' );
define( 'TEXT_DOCUMENT_IMAGE_DIR', 'Katalog obrazka:');
define( 'TEXT_DOCUMENT_URL', 'Link do dokumentu: ' );
define( 'TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(bez http://)</small>' );
define( 'TEXT_PRODUCTS_SORT_ORDER', 'Sortowanie: ' );
