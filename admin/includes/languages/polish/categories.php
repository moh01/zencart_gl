...
define( 'WARNING_PRODUCTS_IN_TOP_INFO', 'OSTRZE¯ENIE: Istniej± produkty w kategorii g³ównej. Jest to b³±d! Produkty nale¿y przenie¶æ do kategorii, które nie zawieraj± podaktegorii. Znalezione produkty: ' );

define( 'TEXT_INFO_HEADING_STATUS_CATEGORY', 'Zmieñ ststus kategorii z: ' );
define( 'TEXT_CATEGORIES_STATUS_WARNING', '<strong>OSTRZE¯ENIE...</strong><br />Uwaga: Wy³±czenie kategorii wy³±czy równie¿ wszystkie produkty w tej kategorii. Produkty powi±zane umieszczone w tej kategorii bêd± tak¿e niedostêpne dla innych kategorii.' );
define( 'TEXT_CATEGORIES_STATUS_INTRO', 'Zmieñ ststus kategorii na: ' );
define( 'TEXT_CATEGORIES_STATUS_OFF', 'WY£¡CZONA' );
define( 'TEXT_CATEGORIES_STATUS_ON', 'W£¡CZONA' );
define( 'TEXT_PRODUCTS_STATUS_INFO', 'Zmieñ ststus wszystkich produktów na: ' );
...
define( 'TEXT_CATEGORIES_IMAGE_MANUAL', '<strong>lub wybierz obrazek istniej±cy na serwerze wpisuj±c jego nazwê, nazwa pliku:</strong> ' );
...
define( 'TEXT_DELETE_CATEGORY_INTRO_LINKED_PRODUCTS', '<strong>Ostrze¿enie:</strong> Powi±zane produkty, które zawiera kategoria zostan± usuniête. Powiniene¶ najpierw zlikwidowaæ powi±zania produktów np.: poprzez przeniesienie ich do kategorii g³ównej zanim usuniesz kategoriê' );
...
define( 'TEXT_INFO_HEADING_EDIT_CATEGORY_META_TAGS', 'Definicje MetaTagów' );
...
define( 'ERROR_CANNOT_ADD_PRODUCT_TYPE', 'Ten rodzaj produktów nie mo¿e byæ dodany do tej kategorii. Sprawd¼ ograniczenia kategorii.' );
...
define( 'TEXT_SHIPPING_INFO', 'Dla <strong>produktów wirtualnych</strong> nie musisz ustawiaæ rodzaju wysy³ki i nie wymaga siê adresu wysy³ki np. dla: Bonów towarowych, etc.<br />' . '<strong>Zawsze darmowa wysy³ka</strong> nie wymaga wybierania rodzaju wysy³ki, ale wymaga adresu wysy³ki<br />' . '<strong>Pobieranie</strong> podobnie jak produkty wirtualne - Inne opcje wysy³ki musz± byæ wybrane<br />' );
