 ...
 * @version $Id: italian.php 4385 2006-10-04 04:10:48Z spike00 $
 */
...
define('BOX_CONFIGURATION_LOGGING', 'Accedere');
...
define('BOX_CATALOG_SALEMAKER', 'FareSaldi');
...
define('BOX_REPORTS_CUSTOMERS_REFERRALS', 'Referenti della Clientela');

// tools text in includes/boxes/tools.php
define('BOX_HEADING_TOOLS', 'Strumenti');
define('BOX_TOOLS_ADMIN', 'Settaggi Admin');
...
define('BOX_HEADING_GV_ADMIN', TEXT_GV_NAME . '/Buoni');
...
define('BOX_COUPON_ADMIN','Amministrazione Buono');
...
define('JS_CITY', '* Nel campo \'Città\' vanno inseriti almeno ' . ENTRY_CITY_MIN_LENGTH . ' caratteri.\n');
...
define('JS_PASSWORD', '* I campi \'Password\' e \'Conferma\' devono corrispondere e avere almeno ' . ENTRY_PASSWORD_MIN_LENGTH . ' caratteri.\n');
...
define('WARNING_CONFIG_FILE_WRITEABLE', '<strong>ATTENZIONE:</strong> Il file di configurazione: %sincludes/configure.php &egrave; scrivibile. Questa situazione è potenzialmente rischiosa - modifica adeguatamente i permessi di questo file (sola lettura, tipicamente CHMOD 644 o 444).');
...
// check GV release queue and alert store owner
  ...
  define('BOX_TOOLS_EMAIL_WELCOME','Email di Benvenuto');
...
define('TEXT_STATUS_WARNING','<strong>NOTA:</strong> lo status è impostato automaticamente quando vengono utilizzate le date.');
...
define('ERROR_USPS_STATUS', '<strong>Attenzione:</strong> nel modulo USPS manca la username, oppure è settato a TEST piuttosto che PRODUCTION.<br />Se non recuperi i dati da USPS, contatta USPS per attivare il tuo account sul loro server di produzione. 1-800-344-7779 o icustomercare@usps.com');
...
define('ENTRY_NOTHING_TO_SEND','Non c\'&egrave; contenuto nel messaggio');
 define('EMAIL_SEND_FAILED','ERRORE: invio email fallito a "%s" <%s> con oggetto "%s"');
  ...
  define('TEXT_IMAGES_OVERWRITE', 'Sovrascrivere l\'immagine esistente?<br />Usare NO per nomi<br />inseriti manualmente');
...
// moved from categories and all product type language files
  ...
  define('ERROR_CATEGORY_HAS_PRODUCTS', 'Errore: La Categoria contiene Prodotti!<br /><br />Questa operazione pu&ograve; essere effettuata temporaneamente pr costruire le Categorie ... Le Categorie possono contenere sia Prodotti sia altre categorie ma mai entrambi!');
...
// admin activity log warnings
  ...
  define('RESET_ADMIN_ACTIVITY_LOG', 'Vai allo Store Manager e Resetta l\'Admin Activity Log');

  define('CATEGORY_HAS_SUBCATEGORIES', 'NOTE: La Categoria ha Sotto Categorie<br />Non &egrave; possibile aggiungere Prodotti');
