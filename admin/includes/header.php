...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr class="headerBar" height="20" width="100%">
	...
	<a href="encours_frame.php" target=_new><font color="fceff0">En cours</font> </a>
	&nbsp;&nbsp;&nbsp;<a href="clients.php?ticket_type=rma" style="font-color:fceff0;" target=_new><font color="fceff0"> RMA </font></a>
	&nbsp;&nbsp;&nbsp;<a href="el_payments.php"  target=_new> <font color="fceff0"> Remises </font> </a>
	&nbsp;&nbsp;&nbsp;<a href="bi_launcher.php"> <font color="fceff0"> Stats </font> </a>
<?php	
  if ( $_SESSION['admin_id']==5 )
  {
     echo '&nbsp;&nbsp;&nbsp;<a href="margin_frame.php" target=_blank> <font color="fceff0"> Marges </font> </a>';
  }
 
?>
	&nbsp;&nbsp;&nbsp;<a href="../extractions/el_excel_outputs.php?query_id=4"  target=_new> <font color="fceff0"> Eco contrib </font> </a>
	&nbsp;&nbsp;<a href="extractions_compta.php" > <font color="fceff0"> Extractions </font>&nbsp;&nbsp;<a href="coface_input.php" target=_new> <font color="fceff0"> Coface </font> </a>

	<?php
	   if ($questionc)
	   {
			echo '&nbsp;&nbsp;&nbsp;<a href="email_generator.php"  target=_new> <font color="fceff0"> generation Emails  </font> </a>';
	   }
	?>
...
*/	  
    ...
    <td class="headerBarContent" align="center"><b>
	<?php 
	   echo '<a href="http://www.easylamps.fr/docs/support_clients-3-1.pdf" target=_new>';
	   
	   echo '<font color=yellow>QU\'EST CE QUE JE FAIS CHEZ ';
	   
	   if ( $questionc  )
	     echo ' NET-CERTIFICATE';
	   else
	     echo ' EASYLAMPS';
		 
	   echo '&nbsp;<img height=15 src=help.gif></font></a>';
