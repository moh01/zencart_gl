  ...
  else
  {
     //mysql5-15
	  ...
	  else
	  {
	      if ($histo)
		  {
			  define('HTTP_SERVER', 'http://capsulecaoua.com');
			  define('HTTPS_SERVER', 'https://capsulecaoua.com');
			  define('HTTP_CATALOG_SERVER', 'http://capsulecaoua.com');
			  define('HTTPS_CATALOG_SERVER', 'https://capsulecaoua.com');	 
		  }
          else
		  {
//echo $_SERVER['SERVER_NAME'];exit;	
	  
			  if ($_SERVER['SERVER_NAME']=="www.linats.net")
			  {
				  define('HTTP_SERVER', 'http://www.linats.net');
				  define('HTTPS_SERVER', 'https://www.linats.net');
				  define('HTTP_CATALOG_SERVER', 'http://www.linats.net');
				  define('HTTPS_CATALOG_SERVER', 'https://www.linats.net');	 
			  } 
			  else if ($_SERVER['SERVER_NAME']=="easylamps.net")
			  {
				  define('HTTP_SERVER', 'http://easylamps.net');
				  define('HTTPS_SERVER', 'https://easylamps.net');
				  define('HTTP_CATALOG_SERVER', 'http://easylamps.net');
				  define('HTTPS_CATALOG_SERVER', 'https://easylamps.net');	 
			  } 			  
			  else // on est en  dédié
			  {
				  define('HTTP_SERVER', 'http://94.23.70.222/~rootbo');
				  define('HTTPS_SERVER', 'https://94.23.70.222/~rootbo');
				  define('HTTP_CATALOG_SERVER', 'http://94.23.70.222/~rootbo');
				  define('HTTPS_CATALOG_SERVER', 'https://94.23.70.222/~rootbo');	 			  
			  }
		  }
	  }
  }
...
//echo   $questionc;exit;
	  ...
	  {
		  if ( 
				($_SERVER['SERVER_NAME']=="www.linats.net")
				|| ($_SERVER['SERVER_NAME']=="easylamps.net") )
		  {
			  define('DIR_FS_ADMIN', '/home/easylamp/www/zencart_gl/admin/');
			  define('DIR_FS_CATALOG', '/home/easylamp/www/zencart_gl/');
		  } 
		  else // on est sur le dédié
		  {
			  define('DIR_FS_ADMIN', '/home/rootbo/www/');
			  define('DIR_FS_CATALOG', '/home/rootbo/www/');
		  } 
...
//echo DB_SERVER;exit;
  ...
  if ( $local )
  {
	 ...
	 else
	 {
	     ...
	     $ext_db_database['bf'] = 'batteries_eu';
  ...
  else
  {
	 ...
	 else
	 {
	     if ($histo)
		 {
		     $ext_db_database['gl'] = 'easylampgl2009';
		     $ext_db_server['gl'] = 'mysql5-2';
		     $ext_db_username['gl'] = 'easylampgl2009';
		     $ext_db_password['gl'] = 'abidjan5';
		     $ext_db_type['gl'] = 'A';	 
		  ...
		  else
		  {
			  ...
			  if ( true )
			  {
				 ...
				 $ext_db_type['gl'] = 'A';	 
				 $ext_db_name['gl'] = 'Compta';	 
				 $ext_bd_root['gl'] = 'http://easylamps.net';				 
			  }
			  else // on est sur le dédié
			  {
				 $ext_db_database['gl'] = 'gl';
				 $ext_db_server['gl'] = 'localhost';
				 $ext_db_username['gl'] = 'root';
				 $ext_db_password['gl'] = 'k1LLIFne';
				 $ext_db_type['gl'] = 'A';	 
				 $ext_db_name['gl'] = 'Compta';	 
				 $ext_bd_root['gl'] = 'http://www.easylamps.eu';
...
/* 
		 ...
		 $ext_db_database['po'] = 'easylampcmd';
	     $ext_db_server['po'] = 'mysql5-4';
	     $ext_db_username['po'] = 'easylampcmd';
	     $ext_db_password['po'] = 'abidjan5';
	     $ext_db_type['po'] = 'A';	 
	     $ext_db_name['po'] = 'PO';	 
		...
		//  if ($_SERVER['SERVER_NAME']=="www.linats.net")
		  ...
		  {
			 $ext_db_database['fr'] = 'devlampe';
			 $ext_db_server['fr'] = 'localhost';
			 $ext_db_username['fr'] = 'root';
			 $ext_db_password['fr'] = 'k1LLIFne';
			 $ext_db_type['fr'] = 'A';	 
		  }
	     ...
	     $ext_db_database['bf'] = 'easylampespagn';
	     $ext_db_server['bf'] = 'mysql5-5';
	     $ext_db_username['bf'] = 'easylampespagn';
	     $ext_db_password['bf'] = 'abidjan5';
	     $ext_db_type['bf'] = 'E';	 
	     $ext_db_name['bf'] = 'PCP eu';	 	 
	     $ext_bd_root['bf'] = 'http://www.easybatteries.fr';
		 
	     $ext_db_database['hp'] = 'easylamphpl';
	     $ext_db_server['hp'] = 'mysql5-21';
	     $ext_db_username['hp'] = 'easylamphpl';
	     $ext_db_password['hp'] = 'abidjan5';
	     $ext_db_type['hp'] = 'E';	 
	     $ext_db_name['hp'] = 'HPL eu';	 	 
...
//echo  DB_SERVER . DB_SERVER_USERNAME . DB_DATABASE  .  DB_SERVER_PASSWORD;exit;
