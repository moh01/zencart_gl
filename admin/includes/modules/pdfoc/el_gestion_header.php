...
<!-- 
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="3">
          <tr>
          <td class="dataTableHelptext" width="15"><a class="helptextPopup" id="pdfocGeneralHelptext" href="<?php echo zen_href_link(FILENAME_EL_PDFOC,'action=refresh'); ?>"><?php echo PDFOC_HELPTEXT_ICON; ?><span><?php echo PDFOC_GENERAL_HELPTEXT; ?></span></a></td>
          ...
          <td class="pageHeading" align="right"><?php echo zen_draw_form('pdfoc_main', FILENAME_EL_PDFOC); ?><input type="submit" value="<?php echo PDFOC_LINK_MAINPAGE; ?>" /></form></td>
          </tr>
        </table></td>
      </tr>
      <tr>
