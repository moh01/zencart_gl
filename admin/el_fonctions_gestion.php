...
<head>
 ...
 content="text/html; charset=ISO-8859-1">
  <title>Détail stock virtuel</title>
...
<br>
 ...
 border="1" cellpadding="2" cellspacing="2">
              <tbody border="0">
                <tr>
                  <td><span
 style="font-weight: bold; text-decoration: underline;">Denières
...
attente</td>
                  <td style="background-color: rgb(204, 204, 204);">expédiées</td>
                </tr>
              </tbody>
            <table id="table_results" class="data"
...
//echo $sql.'<br>';
		...
		if (strlen($site_vendeur)>0)
		{
			...
			echo "<font size=3 color=orange>Produit expédié le ".$sent_date. " sur site ".$site_vendeur. " numéro de commande: ". $rs2->fields['orders_id'].'</font><br><br>';
		}		
...
//return($db_code);
		...
		*/
		...
		$output .= add_field_common("2"); // région 
...
//  $service_level fév 2O14, le service level est alternativement express saver SV
//  juillet 2014
// zone 1
...
//echo 'prd'.$ord_products->fields['products_model'].'<br>';			
			   ...
			   // 'SHF','CODF','ECOF','ESCF','FRSH','FRS'
				...
				// vérification de l'existence d'un coupon
				if ( $chkDispatch == 0)
				{
					$new_products[$products_cnt] = array('orders_id' => $oID,
