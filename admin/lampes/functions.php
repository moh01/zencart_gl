...
function get_tab_html ( $tab_ids , $tab_labels,  $p_sel_tab=0 )
{
       ...
       # t_ids et $t_labels présentent une liste avec des séparateurs virgule
...
// renvoie les libelles transformés ------------------------------------------------------------
...
function chaine_commencePar($chaine, $prefixe)
{
...
function chaine_suivant($chaine, $separateur)
{
	$resultat = false;
...
function chaine_precedent($chaine, $separateur)
{
	$resultat = false;
	$posSeparateur = strpos($chaine, $separateur);
	if ($posSeparateur !== false)
