    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="pageHeading"><a href="whos_online.php">Fréquentation courante</a></td>
            <td class="pageHeading"><a href="whos_online.php?show_all=1">Historique de fréquentation</a></td>
          </tr>		  
          <tr>
            <td class="pageHeading"><a href="whos_online.php?purge=1&show_all=1"><br>Purge de l'historique <br><br></a></td>
...
<?php
  ...
  if ($_GET['show_all'] == 1)
  {
    $order = "full_name, time_last_click DESC";
    $table_who = 'whos_online_bckp';
    if ($_GET['purge'] == 1)
       $db->Execute("delete from whos_online_bckp 
  ...
  $whos_online = $db->Execute("select customer_id, full_name, ip_address, time_entry, time_last_click,
                               ...
                               from " . $table_who  . "
							   where customer_id in (  select a.customers_id from address_book a where a.entry_country_id in (  " . get_countries_from_language (  $_SESSION['languages_id']  ) .  " ) )
                               order by $order");
