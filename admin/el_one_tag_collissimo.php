...
function makefile(){
	...
	thefile=fso.CreateTextFile("C:\\\\expinet\\\\import_commandes\\\\cmd_'.$_SESSION['source_db'].'_'.$_GET['ord_id'].'.csv",true);		
    ...
    //alert(\'Le fichier est crée.\');	
       ...
       $sourcedb = $_SESSION['source_db'];
        ...
        $ups_xml = get_flux_collissimo($_GET['ord_id'],$_SESSION['source_db']);
