...
500    Northern Ireland
  ...
  */
  ...
  function get_product_code ($p_product_type,$tax,$country,$short_name,$moyen_paiement,$ref_info)
  {
     if ($tax==0)
	 {
		if ( strrpos( '.14,21,57,72,81,98,103,105,124,150,171,195,197,
		                203,222,103,21,124,67,57,72,150,203,123,117,84,175,33,
						170,56,190,97,189,72,67,132,117,123',  $country ) > 0 )
		  $country_code = "ue";
		else
		  $country_code = "ex";		
	 }        
	 /* JAN 2012    ROMANIA 175   SLOVENIA 190    GREECE 84	 */
     else  if ( ($country==73)|| ($country==75)|| ($country==141) // france  et  monaco
     ...
     else if ( $p_product_type=="TOTALTVA" )
     {
        ...
        if ( $country_code=="fr" )
           ...
           $response = '445710';//           $response = "445750";  
	        ...
	        $response = "445771";    //$response = "445770";   
		else if ( $country_code=="ie" ) 
...
//echo 	 $country;
        ...
        else if ( ($country==73)|| ($country==75) || ($country==141)  ) 
		{
...
//        else if ( ($country==195)|| ($country==196)|| ($country==197) )  // espagne
     ...
     else
     {
        ...
        if ( $country_code=="fr" )
           ...
           $terminaison = "919"; // $terminaison = "060";        
		else if ( $country_code=="ie" )
           $terminaison = "925";        
...
<!-- Display Header -->
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
          <?php echo zen_draw_form('search', 'report_consultations.php', '', 'get'); ?>
          <tr>
          ...
          <tr>
            <td valign="top"><table border="0" cellspacing="2" cellpadding="0">
              ...
              <tr>
                <td class="main" valign="top"><input type="radio" name="target" value="EU" >End User</td>
				<td class="main" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>								
				<td class="main" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>												
              </tr>
              <tr>
...
<?php
  ...
  if (true) 
  {
	  if ( $csv_output )
	  {
		  ...
		  $output .=  'Ventes OI LC' . $csv_separator;		  
		  $output .= '
';
		  echo $output;
		}
