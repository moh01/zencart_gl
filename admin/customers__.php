...
<?php
  if ($processed == true) {
    ...
    echo zen_draw_pull_down_menu('main_price_list_id', $price_array, $cInfo->main_price_list_id);

  }
?></td>
          </tr>
          <tr>
            <td class="main"><?php echo "Liste de Prix"; ?></td>
            <td class="main">
...
<?php
  if ($processed == true) {
    ...
    $price_list_query = $db->Execute("select name from el_price_list where price_list_id = '" . $cInfo->main_price_list_id . "'");
    ...
    $price_array[] = array('id'=>0, 'text'=>TEXT_NONE);
    while (!$price_list_query->EOF) {
      $price_array[] = array('id'=>$price_list_query->fields['price_list_id'], 'text'=>$price_list_query->fields['name']);
      $price_list_query->MoveNext();
    }
    echo zen_draw_pull_down_menu('main_price_list_id', $price_array, $cInfo->main_price_list_id);
