...
*/
require_once( 'CParser.class.php');
...
class CWorksheet extends CBIFFwriter {
    ...
    */
    function CWorksheet($name,$index,&$activesheet,&$firstsheet,&$url_format,&$parser)
    {
    ...
    */
    function write_formula($row, $col, $formula, $format = 0)
    {
        ...
        // Parse the formula using the parser in CParser.class.php
    ...
    function write_formule($row, $col, $formula, $format = 0)
    {
        $record    = 0x0006;     // Record identifier
