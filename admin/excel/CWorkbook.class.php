...
*/
require_once('CFormat.class.php');
require_once('COLEwriter.class.php');
require_once('CBIFFwriter.class.php');
...
class CWorkbook extends CBIFFwriter {
    /**
    * Class constructor
    *
    * @param string filename for storing the workbook. "-" for writing to stdout.
    */
    function CWorkbook($filename) {
        $this->CBIFFwriter(); // It needs to call its parent's constructor explicitly
    
        $this->_filename         = $filename;
        $this->parser            = new CParser($this->_byte_order);
        $this->_1904             = 0;
        $this->activesheet       = 0;
        $this->firstsheet        = 0;
        $this->selected          = 0;
    ...
    */
    function &add_worksheet($name = '')
    {
        ...
        $worksheet = new CWorksheet($name,$index,$this->activesheet,
    ...
    */
    ...
    {
        $format = new CFormat($this->xf_index,$properties);
        $this->xf_index += 1;
        $this->formats[] = &$format;
        return($format);
    }
    ...
    */
    ...
    {
        $OLE  = new COLEwriter($this->_filename);
