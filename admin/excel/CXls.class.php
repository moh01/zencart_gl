...
class  CXls {
      ...
      var  $default_dir = '';
      var  $filename  = "defaultfile";       // save filename
...
*/
	...
	function _SendFile() {
      ...
      $this->End();
		...
		//	First part of the header: past expiration date
		header("Expires: Fri, 11 Dec 1959 08:00:00 GMT");
		header("Last-Modified: " . gmdate ("D, d M Y H:i:s") . " GMT");

		//
		eregi("IE 5", $HTTP_USER_AGENT) ? $msie5 = true : $msie5 = false;
		...
		if ($msie5) {
			...
			// header("Content-Length: " . filesize($local_pathfile));
