...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                <td class="dataTableContent" align="right"><?php echo $products->fields['id']; ?>&nbsp;&nbsp;</td>
                <td class="dataTableContent"><?php echo '<a target=_new href="el_live_report.php?request_id=' . $products->fields['id'] . '">' . $products->fields['name'] . '</a> (' . $products->fields['name'] . ')'; ?></td>
