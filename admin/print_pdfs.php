...
function makefile()
{
    alert(\'Le fichier est crée0.\');	

	var objShell = new ActiveXObject("shell.application");        
	objShell.ShellExecute("notepad.exe", "", "", "open", 1);
		
     alert(\'Le fichier est crée.1\');	
}
  </SCRIPT>';
 /*
echo '
<script language="VBScript"> 
    ...
    Sub makefile 
        ...
        objShell.Run "notepad.exe c:\tmp\test.txt"
    End Sub
...
*/
       ...
       $sourcedb = $_SESSION['source_db'];
        ...
        $ups_xml = get_xml_ups($_GET['ord_id'],$_SESSION['source_db']);
		
        $ups_xml = '<?xml version="1.0" encoding="UTF-8"?>
<OpenShipments xmlns="x-schema:OpenShipments.xdr">'. $ups_xml .'
</OpenShipments>';
