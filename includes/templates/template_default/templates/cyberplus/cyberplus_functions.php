...
<!--	Affichage du header html	-->
 <?php
  function get_card_selection()
  {
    	...
    	$parm="$parm pathfile=/home/easylamp/www/sites/zenCart/cyberplus/param/pathfile";
    	...
    	$path_bin = "/home/easylamp/www/sites/zenCart/cyberplus/bin/request";
      ...
      if (( $code == "" ) && ( $error == "" ) )
     	{
      	$return_html .= "<BR><CENTER>erreur appel request</CENTER><BR>";
      	$return_html .= "executable request non trouve ".$path_bin;
     	}
    
    	//	Erreur, affiche le message d'erreur
    
    	else if ($code != 0){
    		$$return_html .= "<center><b><h2>Erreur appel API de paiement.</h2></center></b>";
    		$return_html .= "<br><br><br>";
    		$return_html .= " message erreur : $error <br>";
    	}
