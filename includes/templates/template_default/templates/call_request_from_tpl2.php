...
<!--	Affichage du header html	-->
 <?php
	...
	$path_bin = "../../../../cyberplus/bin/request";
  ...
  if (( $code == "" ) && ( $error == "" ) )
    ...
    $message = str_replace ('<DIV ALIGN=center>- Si vous utilisez le formulaire s&#233;curis&#233; standard SSL, choisissez une carte ci-dessous  <IMG BORDER=0 SRC="/sites/zenCart/cyberplus/logo/CLEF.gif"> :<br><br></DIV>','',$message);
    echo $message;
//		print ("  $message ");
	}
?>
