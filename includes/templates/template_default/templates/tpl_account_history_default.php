...
<div class="notice forward">
<?php 
    echo TEXT_ORDER_STATUS;
    if ( $history['orders_status_name']=="Pending" )
    {
        echo "En attente";
    }
    else
 ...
 ?></div>
<br class="clearBoth" />
    <div class="content back"><?php echo '<strong>' . TEXT_ORDER_DATE . '</strong> ' . zen_date_short($history['date_purchased']) . '<br /><strong>' . $history['order_type'] . '</strong> ' . zen_output_string_protected($history['order_name']); ?></div>
