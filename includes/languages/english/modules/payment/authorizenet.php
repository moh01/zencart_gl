...
//
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_ADMIN_TITLE', '30 days payment');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CATALOG_TITLE', '30 days payment (under authorization)');  // Payment option title as displayed to the customer
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION', 'This will be due 30 days after the invoice.');
