...
define('HEADING_NEW_CUSTOMER','Alleprojektorlampen Login erstellen:');
define('HEADING_NEW_CUSTOMER_SPLIT', 'Neue Kunden');

define('TEXT_NEW_CUSTOMER_INTRODUCTION','Bestellen Sie online. Loggen Sie sich ein, um von unseren individuellen Angeboten zu profitieren.');
...
define('HEADING_RETURNING_CUSTOMER_SPLIT', ' ');

define('TEXT_RETURNING_CUSTOMER_SPLIT', 'Zum Fortfahren, bitte anmelden');

define('TEXT_PASSWORD_FORGOTTEN','Sie haben Ihr Passwort vergessen? Dann klicken Sie hier');
