...
define('TEXT_MAIN','Qui si inserisce il testo che si desidera oppure lo si elimina cancellando quanto presente fra i due apici. Lo si trova in: <strong>/includes/languages/italian/index.php</strong>');

// Showcase vs Store
if (STORE_STATUS == '0') {
  define('TEXT_GREETING_GUEST', 'Benvenuto, <span class="greetUser">Ospite</span> e buona navigazione fra le nostre pagine !<br><br> Vuoi accedere con la <a href="%s">tua identit&agrave;</a> ?');
} else {
  define('TEXT_GREETING_GUEST', 'Salve, naviga pure liberamente tra le nostre pagine .');
}
