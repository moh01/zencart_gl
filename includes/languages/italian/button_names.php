...
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Torna a elenco articoli');
...
define('BUTTON_SUBMIT_ALT', 'Invia l\'info');
define('BUTTON_TELL_A_FRIEND_ALT', 'PassaParola');
define('BUTTON_TELLAFRIEND_ALT', 'PassaParola');
...
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Vai alle Informazioni Dettagliate di questo Prodotto');
