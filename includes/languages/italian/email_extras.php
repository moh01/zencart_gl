...
// email disclaimer
  define('EMAIL_DISCLAIMER', 'Questo indirizzo e-mail ci è stato fornito da un nostro cliente. Se ritieni che questo messaggio ti sia giunto per errore, ti preghiamo di inviare una segnalazione via mail a %s ');
  define('EMAIL_SPAM_DISCLAIMER','Se non desideri pi&ugrave; ricevere questa email puoi richiedere la rimozione a questo indirizzo.');
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) 2003-2006 <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>. Powered by <a href="http://www.zen-cart.it" target="_blank">Zen-Cart.it</a>');

// email advisory for all emails customer generate - tell-a-friend and GV send
  define('EMAIL_ADVISORY', '-----' . "\n" . '<strong>IMPORTANTE - </strong> Per la tua tutela e per prevenire abusi, tutte le e-mail spedite a mezzo di questo sito sono registrate e il webmaster pu&ograve; visualizzarne il contenuto. Se ritieni che questo messaggio ti sia giunto per errore, ti preghiamo di inviare una segnalazione via mail a ' . STORE_OWNER_EMAIL_ADDRESS . "\n\n");
