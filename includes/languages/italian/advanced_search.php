...
define('TABLE_HEADING_BUY_NOW', 'Aqcuista');
  ...
  define('ERROR_INVALID_FROM_DATE', '<b>Data da</b> non valida.');
  define('ERROR_INVALID_TO_DATE', '<b>Data fino a</b> non valida.');
  define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'La <b>data fino a</b> deve essere maggiore o uguale alla data da.');
  define('ERROR_PRICE_FROM_MUST_BE_NUM', 'Il <b>prezzo da</b> va espresso in cifre.');
  define('ERROR_PRICE_TO_MUST_BE_NUM', 'Il <b>prezzo fino a</b> va espresso in cifre.');
  define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'Il <b>prezzo fino a</b> deve essere maggiore o uguale al prezzo da.');
