...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; 2003-2006 <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>. Powered by <a href="http://www.zen-cart.it" target="_blank">Zen Cart</a>');
...
define('BOX_INFORMATION_CONTACT', 'Per contattarci');
...
define('ENTRY_NICK_DUPLICATE_ERROR', 'Questo soprannome &egrave; gi&agrave; in uso.');
...
define('ENTRY_STATE_ERROR_SELECT', 'Seleziona una Provincia dal men&ugrave; a cascata.');
  define('ENTRY_STATE_TEXT', '*');
define('JS_STATE_SELECT', '-- Seleziona --');
define('ENTRY_COUNTRY', 'Paese:');
define('ENTRY_COUNTRY_ERROR', 'Seleziona un Paese dal men&ugrave; a discesa.');
