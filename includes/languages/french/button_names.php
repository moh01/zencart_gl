 ...
 */
define('BUTTON_ADD_TO_CART_ALT', 'Ajouter &agrave; mon panier');
define('BUTTON_ADD_ADDRESS_ALT', 'Ajouter adresse');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Ajouter le produit s&eacute;lectionn&eacute;');
define('BUTTON_BACK_ALT', 'Pr&eacute;cedent');
define('BUTTON_BUY_NOW_ALT', 'Acheter maintenant');
define('BUTTON_CANCEL_ALT', 'Annuler');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Changer l\'adresse');
define('BUTTON_CHECKOUT_ALT', 'Valider');
define('BUTTON_CONFIRM_SEND_ALT', 'Envoyer certificat cadeau');
define('BUTTON_CONFIRM_ORDER_ALT', 'Confirmer la commande');
define('BUTTON_CONTINUE_ALT', 'Continuer');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Continuer le magasinage');
define('BUTTON_DELETE_ALT', 'Effacer');
define('BUTTON_DOWNLOAD_ALT', 'T&eacute;l&eacute;charger maintenant');
define('BUTTON_EDIT_SMALL_ALT', 'Modifier');
define('BUTTON_IN_CART_ALT', 'Ajouter au panier');
define('BUTTON_LOGIN_ALT', 'S\identifer');
define('BUTTON_NEXT_ALT', 'Suivant');
define('BUTTON_PREVIOUS_ALT', 'Pr&eacute;cedent');
define('BUTTON_REDEEM_ALT', 'Redeem');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Retourner &agrave; la liste de produit');
define('BUTTON_REVIEWS_ALT', 'Aller &agrave; la page de revues de produits');
define('BUTTON_SEARCH_ALT', 'Recherche');
define('BUTTON_SEND_ALT', 'Rechercher maintenant');
define('BUTTON_SEND_ANOTHER_ALT', 'Envoyer un autre certificat cadeau');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Envoyer un certificat cadeau');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Estimateur de co&ucirc;t de livraison');
define('BUTTON_SOLD_OUT_ALT', 'Pas en inventaire');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Pas en inventaire');
define('BUTTON_SUBMIT_ALT', 'Envoyer l\information');
define('BUTTON_TELL_A_FRIEND_ALT', 'Envoyer &agrave; un ami');
define('BUTTON_TELLAFRIEND_ALT', 'Envoyer &agrave; un ami');
define('BUTTON_UNSUBSCRIBE', 'Annuler mon inscription');
define('BUTTON_UPDATE_ALT', 'Mettre &agrave; jour');
define('BUTTON_VIEW_SMALL_ALT', 'Voir');
define('BUTTON_WRITE_REVIEW_ALT', '&eacute;crire une revue de produit');
define('BUTTON_READ_REVIEWS_ALT', 'Lire une revue de produit');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Aller &agrave; la page d\'information de ce produit');
define('BUTTON_MORE_REVIEWS_ALT', 'Voir d\'autre revue');
?>