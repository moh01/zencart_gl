 ...
 * @version $Id: meta_tags.php July 2006 www.fweb.biz $
 */
// page title
define('TITLE', 'Easylamps.eu');
// Site Tagline
define('SITE_TAGLINE', 'lampe, videoprojecteur, vid&eacute;oprojecteur, video projecteur, vid&eacute;o projecteur.');
// Custom Keywords
define('CUSTOM_KEYWORDS', ' lampe, videoprojecteur, vid&eacute;oprojecteur, video projecteur, vid&eacute;o projecteur');
