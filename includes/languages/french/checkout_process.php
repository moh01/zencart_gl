...
//
  ...
  define('EMAIL_TEXT_ORDER_NUMBER', 'Numéro:');
  define('EMAIL_TEXT_INVOICE_URL', 'Détails:');
  define('EMAIL_TEXT_INVOICE_URL_CLICK', 'Pour plus de détails, cliquez sur ce lien.');
