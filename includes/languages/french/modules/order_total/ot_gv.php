 ...
 */
  ...
  define('MODULE_ORDER_TOTAL_GV_HEADER', TEXT_GV_NAMES . '/Coupons de R&eacute;duction');
  ...
  define('MODULE_ORDER_TOTAL_GV_USER_PROMPT', 'Appliquer la Balance ->&nbsp;');
  define('MODULE_ORDER_TOTAL_GV_TEXT_ENTER_CODE', TEXT_GV_REDEEM);
  define('TEXT_INVALID_REDEEM_AMOUNT', 'Montant de Balance Incorrect');
  define('MODULE_ORDER_TOTAL_GV_USER_BALANCE', 'Balance Disponible: ');
