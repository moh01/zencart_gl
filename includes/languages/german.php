...
define('TEXT_NO_FEATURED_PRODUCTS', 'Weitere ähnliche Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie unseren Shop regelmä&szlig;ig wieder.');
define('BOX_HEADING_FEATURED_PRODUCTS', 'ähnliche Artikel');
define('CATEGORIES_BOX_HEADING_FEATURED_PRODUCTS', 'ähnliche Artikel...');

define('TEXT_NO_ALL_PRODUCTS', 'Weitere Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie unseren Shop regelmä&szlig;ig wieder.');
...
define('ENTRY_STREET_ADDRESS_ERROR', 'Die Straße/NR muss aus mindestens ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' Zeichen bestehen.');
...
define('ENTRY_STATE_ERROR_SELECT', 'Bitte wählen Sie ein Bundesland aus dem Pulldown Men&uuml;.');
define('ENTRY_STATE_TEXT', '*');
define('JS_STATE_SELECT', '-- Bitte wählen --');
define('ENTRY_COUNTRY', 'Land:');
define('ENTRY_COUNTRY_ERROR', 'Bitte wählen Sie ein Land aus dem Pulldown Men&uuml;.');
...
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING', 'Die Passwortbestätigung stimmt nicht mit dem eingegebenen Passwort &uuml;berein.');
...
define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', 'Die Passwortbestätigung stimmt nicht mit dem neu eingegebenen Passwort &uuml;berein.');
...
define('TEXT_NO_NEW_PRODUCTS', 'Weitere neue Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie unseren Shop regelmä&szlig;ig wieder.');
...
define('WARNING_CONFIG_FILE_WRITEABLE', 'Warnung: In die Konfigurationsdatei kann geschrieben werden: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/includes/configure.php. Dies stellt ein potenzielles Sicherheitsrisiko dar - bitte ändern Sie die Schreibrechte f&uuml;r diese Datei.');
  unset($warn_path);
...
define('WARNING_SQL_CACHE_DIRECTORY_NOT_WRITEABLE', 'Warnung: In das Verzeichnis zum Zwischenspeichern von SQL Abfragen kann nicht geschrieben werden: ' . DIR_FS_SQL_CACHE . '. Bitte ändern Sie die Schreibrechte dieses Verzeichnisses, damit SQL Abfragen zwischengespeichert werden k&ouml;nnen.');
...
define('TEXT_SEND_OR_SPEND','Sie haben Guthaben auf Ihrem ' . TEXT_GV_NAME . 'konto. Wenn Sie m&ouml;chten <br />k&ouml;nnen Sie dieses Guthaben durch Klick auf untenstehende Schaltfläche an eine andere Person senden.');
...
define('TEXT_REMOVE_REDEEM_COUPON_ZONE', 'Der eingegebene Aktionskupon kann mit der ausgewählten Adresse nicht eingel&ouml;st werden.');
...
define('ERROR_PRODUCT_OPTION_SELECTION', '...ung&uuml;ltige Attributmerkmale gewählt -');
...
define('TEXT_AUTHORIZATION_PENDING_BUTTON_REPLACE', '&Uuml;BERPR&Uuml;FUNG LäUFT');
...
define('TEXT_FOOTER_DISCOUNT_QUANTITIES', '* Rabatte k&ouml;nnen abhängig von den unteren Optionen variieren');
...
define('TEXT_PRIVACY_CONDITIONS_DESCRIPTION', 'Bitte bestätigen Sie Ihr Einverständniss mit unseren Datenschutzbestimmungen, indem Sie die Checkbox aktivieren. Die Datenschutzbestimmungen k&ouml;nnen Sie <a href="' . zen_href_link(FILENAME_PRIVACY, '', 'SSL') . '"><span class="pseudolink">hier</span></a> nachesen.');
...
define('ENTRY_EMAIL_PREFERENCE','Gewünschtes E-mail Format');
