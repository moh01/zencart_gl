...
//
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_ADMIN_TITLE', 'Pago a 30 días (sobre autorización)');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CATALOG_TITLE', 'Pago a 30 días (sobre autorización)');  // Payment option title as displayed to the customer
