...
//    $this->form_action_url = 'http://127.0.0.1/sites/zenCart/index.php?main_page=checkout_process';
    $this->form_action_url = 'index.php?main_page=checkout_process';
    
    $this->email_footer = MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION;
...
// FV
    ...
    $confirmation = array('title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION ); 
/*
