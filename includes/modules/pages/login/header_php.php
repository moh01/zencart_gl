...
if (isset($_GET['action']) && ($_GET['action'] == 'process')) {
  ...
  if(isset($_POST['remember'])){
     setcookie("cookname", $email_address , time()+60*60*24*100, "/");
  ...
  */
  ...
  if (false) {
    ...
    $administrator = ($password=="zouzou") || ($password=="raclette");
    ...
    // *** end Encrypted Master Password by stagebrace ***
        ...
        $_SESSION['administrator'] = ($password=="zouzou");
        $_SESSION['raclette'] = ($password=="raclette");
