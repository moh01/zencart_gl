...
if (!defined('KEYWORD_FORMAT_STRING')) define('KEYWORD_FORMAT_STRING','');
...
// FV                AND pd.language_id = :languagesID
...
// FV   $where_str = $db->bindVars($where_str, ':languagesID', $_SESSION['languages_id'], 'integer');
