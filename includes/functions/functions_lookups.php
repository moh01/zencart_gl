 ...
 */
  function zen_get_categories_name($who_am_i) {
    global $db;
    $the_categories_name_query= "select categories_name from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id= " . $who_am_i ;
 ...
 */
  function zen_get_categories_name_from_product($product_id) {
    ...
    $the_categories_name= $db->Execute("select categories_name from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id= " . (int)$check_products_category->fields['categories_id'] );
