...
$taxex = 0;
//echo $_SESSION['customer_country_id'];
if ( ( $_SESSION['customer_id'] ) && ( $_SESSION['customer_country_id'] !=73 ) && ( $_SESSION['customer_country_id'] != 75 )   ) {
    $customers_id = $_SESSION['customer_id'];
$sql = "select 1 no_tax from address_book where entry_tva_intracom <>''  and customers_id = " .$customers_id ;
//echo $sql;
    $customer_check = $db->Execute($sql);
//echo 'm'.$customer_check->fields['no_tax'].'m';exit;
    if ($customer_check->fields['no_tax'] == "1") {
        $taxex = 1;
    }
}
if ($taxex) {	
